...
import dk.iha.onk.group1.server.domainObjects.*;
...
public class SummaryMapper 
{
    ...
    public SummaryDTO generateSummary(Calendar from,Calendar to)
    {
        ...
        {
            alarmInfo = alarm.getProbeId() + " at "
                    +alarm.getTimestamp().getTime()+ " raised alarm with value = " + String.format("%02.1f", alarm.getValue()) + " (upper = "
