namespace SAP
{
    partial class SAPForm
    {
        ...
        {
            SAP.ReadingStation readingStation4 = new SAP.ReadingStation();
            SAP.User user4 = new SAP.User();
            ...
            readingStation4.Enabled = false;
            readingStation4.Name = "";
            this.propertyGridReadingStation.SelectedObject = readingStation4;
            ...
            user4.AccountTypeID = SAP.User.AccountType.USER;
            user4.Password = "";
            user4.Username = "";
            this.propertyGridUsers.SelectedObject = user4;
